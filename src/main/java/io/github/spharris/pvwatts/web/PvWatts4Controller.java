...
public final class PvWatts4Controller {
  ...
  public PvWatts4Response  versionFourXmlResource(@Context UriInfo uriInfo) {
    return service.execute(convertMap(uriInfo.getQueryParameters()));
  }
  ...
  private static ImmutableMultimap<String, String> convertMap(MultivaluedMap<String, String> map) {
