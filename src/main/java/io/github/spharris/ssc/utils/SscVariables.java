...
public final class SscVariables {
  ...
  private abstract static class AbstractVariable<T> implements SscVariable<T> {
   ...
   */
  public static InputVariable<ImmutableList<Float>> arrayInput(final String varName) {
